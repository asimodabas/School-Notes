...
import kotlinx.android.synthetic.main.activity_detay.editTextDerss
import kotlinx.android.synthetic.main.activity_detay.editTextNot11
import kotlinx.android.synthetic.main.activity_detay.editTextNot22
import kotlinx.android.synthetic.main.activity_detay.toolbarNotDetay
        ...
        when (item.itemId) {
            ...
            R.id.action_duzenle -> {
                ...
                if (TextUtils.isEmpty(dersAdi)) {
                    Snackbar.make(toolbarNotDetay, "Enter lesson name", Snackbar.LENGTH_SHORT)
                        .show()
                    return false
                }
